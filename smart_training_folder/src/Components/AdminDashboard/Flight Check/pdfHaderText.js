...
function pdfHaderText({formData}) {
  ...
  return (
    <div style={{ ...styles.div }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+0.5), left: cmToP(x+9.7) }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+0.9), left: cmToP(x+9.7) }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+1.3), left: cmToP(x+9.7) }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+1.7), left: cmToP(x+9.7) }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+2.1), left: cmToP(x+9.7) }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+2.5), left: cmToP(x+9.7) }}>
    ...
    <Text style={{ ...styles.headerText, top: cmToP(y+0.1), left: cmToP(x+13.8) }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+0.5), left: cmToP(x+13.8) }}>
      ...
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+1.3), left: cmToP(x+13.8) }}>
        {formData.licenseValidity}
      </Text>
      <Text style={{ ...styles.headerText, top: cmToP(y+1.7), left: cmToP(x+13.8) }}>
        Instrument Validity
      </Text>
      <Text style={{ ...styles.headerTextValue, top: cmToP(y+2.1), left: cmToP(x+13.8) }}>
